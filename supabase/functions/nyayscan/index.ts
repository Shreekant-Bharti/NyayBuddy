...
Always respond with valid JSON only, no additional text.`;
      ...
      "https://ai.gateway.lovable.dev/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            {
              role: "user",
              content: `Analyze this legal issue and provide guidance:\n\n${caseDescription}`,
            },
          ],
        }),
      }
    ...
    try {
      ...
      analysis = {
        ...
        summary:
          content || "Unable to analyze the case. Please provide more details.",
        isConsumerCase: false,
        requiresFIR: false,
        prerequisites: [
          "Gather all relevant documents",
          "Note down important dates and details",
        ],
        recommendations: [
