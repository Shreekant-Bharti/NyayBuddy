...
- City: ${formData.senderCity}, ${formData.senderState} - ${
...
- Amount Paid: ${
      formData.amountPaid ? `Rs.${formData.amountPaid}` : "Not specified"
    }
...
- Amount Demanded: ${
      formData.amountDemanded
        ? `Rs.${formData.amountDemanded}`
        : "Not specified"
    }
...
RESPONSE TIME: ${formData.responseTime || "15"} days`;
    ...
    try {
      ...
      noticeData = {
        noticeContent:
          content || "Unable to generate legal notice. Please try again.",
